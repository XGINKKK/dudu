...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      {/* Top Status Bar */}
      <div className="relative z-10 flex justify-between items-center p-6 border-b border-purple-500/20">
        <div className="flex items-center space-x-6">
          <div className="text-purple-400 font-orbitron font-bold text-xl">
            Assistente do Dudu
          </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 flex-1 min-h-0 pt-8 lg:pt-16">
        ...
        <div className="lg:col-span-3 space-y-4 flex flex-col justify-center">
          <StatusPanel 
            ...
            metrics={[
              { label: 'CPU', value: `${cpuUsage.toFixed(1)}%`, color: 'purple' },
              { label: 'RAM', value: `${memoryUsage.toFixed(1)}%`, color: 'green' },
              { label: 'Rede', value: '1.2GB/s', color: 'violet' }
            ]}
          />
          <StatusPanel 
            title="Segurança"
            ...
            metrics={[
              ...
              { label: 'Intrusões', value: '0', color: 'purple' },
              { label: 'Última varredura', value: '15min', color: 'violet' }
            ]}
          />
        </div>
        ...
        <div className="lg:col-span-6 flex items-center justify-center relative min-h-0 mt-4 lg:mt-8">
          <div className="relative">
            ...
            <div className="relative z-10 w-80 h-80 lg:w-96 lg:h-96 rounded-full bg-gradient-to-br from-slate-800/30 to-slate-900/30 backdrop-blur-sm border border-purple-400/20 flex items-center justify-center shadow-2xl">
              <div className="w-64 h-64 lg:w-80 lg:h-80 rounded-full bg-gradient-to-br from-purple-500/5 to-violet-500/5 border border-purple-400/30 flex items-center justify-center relative">
                {/* Breathing effect */}
                <div className="absolute inset-0 rounded-full bg-purple-400/10 animate-ping pointer-events-none" />
                
                {/* Central Label */}
                <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center pointer-events-none">
                  <div className="text-purple-400 font-orbitron font-bold text-lg">
                    Dudu
                  </div>
        ...
        <div className="lg:col-span-3 space-y-4 flex flex-col justify-center">
          <StatusPanel 
            ...
            metrics={[
              ...
              { label: 'Servidores', value: '99.9%', color: 'purple' },
              { label: 'Latência', value: '12ms', color: 'violet' }
            ]}
          />
          <StatusPanel 
            title="Base de Dados"
            ...
            metrics={[
              { label: 'Consultas', value: '1,247', color: 'purple' },
              { label: 'Sincronização', value: 'OK', color: 'green' },
              { label: 'Backup', value: '2h atrás', color: 'violet' }
            ]}
          />
        </div>
      </div>
